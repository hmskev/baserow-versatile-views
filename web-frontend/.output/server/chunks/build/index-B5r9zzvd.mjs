...
!(function() {
  try {
    ...
    n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "76bd2da0-65bd-48ba-9f2f-f76642eeee3d", e._sentryDebugIdIdentifier = "sentry-dbid-76bd2da0-65bd-48ba-9f2f-f76642eeee3d");
  } catch (e2) {
  }
})();
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => navigateTo({ name })), await __temp, __restore();
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("modules/core/pages/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-B5r9zzvd.mjs.map
